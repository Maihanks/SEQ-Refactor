...
def _evidence(tests_pass=True, arch_ok=True, **metric_kwargs) -> Evidence:
    return Evidence(metric=MetricDelta(**metric_kwargs), tests_pass=tests_pass, arch_ok=arch_ok)
