...
| --- | --- | --- | --- | --- | --- |
| H1_fewer_cascading_violations_vs_unordered | yes | 28 | 0.04163 | 1 | supported at p<0.05 (H_alt: greater) |
| H2_higher_nsr_vs_unordered | insufficient data | 28 | n/a | n/a | every paired difference is exactly zero; the test is degenerate. |
| H2_higher_nsr_vs_topo_only | insufficient data | 28 | n/a | n/a | every paired difference is exactly zero; the test is degenerate. |
| H3_higher_auc_vs_topo_only | yes | 28 | 0.0009208 | 0.978 | supported at p<0.05 (H_alt: greater) |
| H4_dependency_mass | no | 28 | 0.4861 | 0.01099 | not supported at p<0.05 (H_alt: greater) |
