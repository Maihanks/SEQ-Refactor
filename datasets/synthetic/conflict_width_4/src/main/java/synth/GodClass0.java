 ...
 * 0.5). Deliberately a God Class: 4
...
public class GodClass0 {
    ...
    // planted: s3 (BigSwitch, severity 0.8)
    ...
    // planted: s4 (BigSwitch, severity 0.6)
    public String m2_bigswitch(int code) {
        switch (code) {
            case 0: return "v0";
            case 1: return "v1";
            case 2: return "v2";
    ...
    // planted: s5 (LongMethod, severity 0.7)
    public int m3_longmethod(int seed) {
        int total = seed;
        total = total + 1;
        total = total + 2;
        total = total + 3;
