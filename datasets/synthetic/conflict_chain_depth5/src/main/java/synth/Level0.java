 ...
 * severity 0.417), level 0 of 4: each level is a real
...
public class Level0 {
    ...
    /** Nested God Class (severity 0.5), level 1. */
    ...
    /** Nested God Class (severity 0.417), level 2. */
    ...
    /** Nested God Class (severity 0.417), level 3. */
    ...
    public int filler3(int x) {
        ...
        // planted: s5 (LongMethod, severity 0.9)
    public int leafMethod(int seed) {
        int total = seed;
        total = total + 1;
        total = total + 2;
        total = total + 3;
