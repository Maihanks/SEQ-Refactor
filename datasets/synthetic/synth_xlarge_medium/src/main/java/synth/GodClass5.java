 ...
 * 0.583). Deliberately a God Class: 2
...
public class GodClass5 {
    ...
    // planted: s17 (LongMethod, severity 0.9)
    public int m0_longmethod(int seed) {
        int total = seed;
        total = total + 1;
        total = total + 2;
        total = total + 3;
    ...
    // planted: s18 (MessageChains, severity 0.9)
    public String m1_messagechains(String input) {
